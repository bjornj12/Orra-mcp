...
**14 MCP tools:** orra_resume, orra_scan, orra_inspect, orra_register, orra_unblock, orra_kill, orra_rebase, orra_setup, orra_directive, orra_spawn, orra_tick, orra_checkpoint, orra_cache_write, orra_attach_ticket
...
- `src/tools/` — MCP tool handlers (14 individual tools)
